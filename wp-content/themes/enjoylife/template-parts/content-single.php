...
<div class="breadcrumbs">
	<span class="breadcrumbs-nav">
		...
		<span class="post-category"><?php enjoylife_first_category(); ?></span>
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content">
		...
		<?php
			dynamic_sidebar('post-top-ad');

			the_content( sprintf(
				/* translators: %s: Name of current post. */
				wp_kses( __( 'Continue reading %s <span class="meta-nav">&rarr;</span>', 'enjoylife' ), array( 'span' => array( 'class' => array() ) ) ),
				the_title( '<span class="screen-reader-text">"', '"</span>', false )
			) );

			wp_link_pages( array(
				'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'enjoylife' ),
				'after'  => '</div>',
			) );
		?>
	</div><!-- .entry-content -->
	...
	<?php 
		dynamic_sidebar('post-bottom-ad');
	?>
...
<?php	 
	...
	$args = apply_filters( 'enjoylife_related_posts_args', $query );
	...
	if ( $related->have_posts() ) : $i = 1; ?>
		...
		<div class="entry-related clear">
			<h3><?php esc_html_e('Related Posts', 'enjoylife'); ?></h3>
			<div class="related-loop clear">
				<?php while ( $related->have_posts() ) : $related->the_post(); ?>
					<div <?php post_class('ht_grid_1_3 ht_grid_m_1_2'); ?>>
