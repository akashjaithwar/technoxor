...
function advance_blogging_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting( 'advance_blogging_latest_post_button_text', array(
		'default'   => __('READ MORE','advance-blogging' ),
		'sanitize_callback'	=> 'sanitize_text_field'
	) );
	$wp_customize->add_control( 'advance_blogging_latest_post_button_text', array(
		'label'    => __( 'Post Button text','advance-blogging' ),
		'section'  => 'advance_blogging_latest_post',
		'type'     => 'text',
		'settings' => 'advance_blogging_latest_post_button_text'
	) );
